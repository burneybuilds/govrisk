        ...
        <div className="border-t border-navy-800/60 px-4 pb-[18px] pt-4">
          ...
          >
            ...
            <div className={`min-w-0 ${collapsed ? "lg:hidden" : ""}`}>
              <p className="truncate text-[15px] font-semibold text-white">Admin User</p>
              <p className="truncate text-[13px] text-navy-300">System Administrator</p>
            </div>
            {collapsed && <CollapsedTooltip label="Admin User" />}
          </div>
        </div>
      </aside>
    </>
