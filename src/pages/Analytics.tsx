...
import { sectorAnalytics, ministryRankings, scatterData } from '../data/analytics';
...
export default function Analytics() {
  const [sortedMinistries] = useState(() =>
    [...ministryRankings].sort((a, b) => b.avgRisk - a.avgRisk)
  );
    ...
    <div className="min-w-0">
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="rounded-xl border border-gray-200 bg-white p-5 lg:p-6">
          ...
          <div className="mt-4">
            <ResponsiveContainer width="100%" height={320}>
              <BarChart data={sectorAnalytics} margin={{ top: 10, right: 12, left: -12, bottom: 0 }}>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5 lg:p-6">
          ...
          <p className="mt-1 text-xs text-gray-500 lg:text-sm">
            Cost overrun percentage vs physical progress across projects.
          </p>
          <div className="mt-4">
            <ResponsiveContainer width="100%" height={320}>
              <ScatterChart margin={{ top: 10, right: 16, left: -8, bottom: 0 }}>
                ...
                <XAxis
                  ...
                  axisLine={{ stroke: '#e5e7eb' }}
                  tickLine={false}
                  label={{ value: 'Physical Progress (%)', position: 'bottom', offset: 2, fontSize: 12, fill: '#6b7280' }}
                  domain={[0, 100]}
                />
                <YAxis
                  dataKey="costOverrun"
                  ...
                  content={({ payload }) => {
                    ...
                    return (
                      <div className="rounded-lg border border-gray-200 bg-white p-3 text-sm shadow-sm">
                        ...
                        <div className="mt-1 text-gray-600">{data.sector}</div>
                        <div className="mt-1 text-gray-600">Progress: {data.physicalProgress}%</div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5 lg:p-6">
          ...
          <div className="mt-4">
            <ResponsiveContainer width="100%" height={320}>
              <BarChart data={sectorAnalytics} layout="vertical" margin={{ top: 0, right: 24, left: 20, bottom: 0 }}>
