...
export const scatterData: ScatterPoint[] = [
  ...
  { name: 'Coastal Port Modernization', physicalProgress: 67, costOverrun: 15, sector: 'Transport' },
  { name: 'Solar Energy Grid', physicalProgress: 73, costOverrun: 9, sector: 'Energy' },
  { name: 'Airport Terminal Expansion', physicalProgress: 54, costOverrun: 21, sector: 'Transport' },
  ...
  { name: 'Mining Infrastructure Corridor', physicalProgress: 28, costOverrun: 32, sector: 'Mining' },
  { name: 'Water Treatment Upgrade', physicalProgress: 69, costOverrun: 11, sector: 'Water' },
  { name: 'Hospital Construction', physicalProgress: 52, costOverrun: 16, sector: 'Social Infrastructure' },
  { name: 'Fiber Optic Backbone', physicalProgress: 85, costOverrun: 6, sector: 'Communication' },
  { name: 'School Construction Program', physicalProgress: 44, costOverrun: 13, sector: 'Social Infrastructure' },
